...
static void InitializeBitStreamReader(BitStreamReader *self)
{
	self->callback=NULL;
	self->context=NULL;
	self->pos=NULL;
...
static void InitializeHuffmanTable(uint16_t *table,int maxlength)
{
...
{
	InitializeHuffmanTable(table,maxlength);
