...
Pixel ReadPixel(Bitmap *bitmap,int x,int y);
Pixel ReadPixelNoClip(Bitmap *bitmap,int x,int y);
...
void DrawBitmap(Bitmap *dest,Bitmap *src,int x,int y);
void DrawBitmapNoClip(Bitmap *dest,Bitmap *src,int x,int y);
void DrawPartialBitmap(Bitmap *dest,Bitmap *src,int x,int y,int u,int v,int w,int h);
void DrawPartialBitmapNoClip(Bitmap *dest,Bitmap *src,int x,int y,int u,int v,int w,int h);
void CompositeBitmap(Bitmap *dest,Bitmap *src,int x,int y,CompositionMode comp);
void CompositeBitmapNoClip(Bitmap *dest,Bitmap *src,int x,int y,CompositionMode comp);
void CompositePartialBitmap(Bitmap *dest,Bitmap *src,int x,int y,int u,int v,int w,int h,CompositionMode comp);
void CompositePartialBitmapNoClip(Bitmap *dest,Bitmap *src,int x,int y,int u,int v,int w,int h,CompositionMode comp);

//void DrawPartialBitmap(Bitmap *dest,Bitmap *src,int x,int y,,,,);
